...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="{{ route('student.portfolios.create') }}" class="btn btn-primary"><i class="bi bi-plus-lg"></i> Tambah Portfolio</a>
</div>
<div class="row g-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-start mb-2">
                    ...
                    <span class="badge {{ $portfolio->verification_status == 'approved' ? 'badge-approved' : ($portfolio->verification_status == 'pending' ? 'badge-pending' : 'badge-rejected') }}">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('student.portfolios.edit', $portfolio->id) }}" class="btn btn-outline-primary btn-sm">Edit</a>
                    @if($portfolio->verification_status != 'pending')
