            ...
            <table class="table table-borderless align-middle">
                <thead>
                    <tr class="text-secondary" style="font-size:0.85rem;">
                        <th>Peringkat</th><th>Mahasiswa</th><th>Program Studi</th><th class="text-end">Total Poin</th>
                    </tr>
                </thead>
                <tbody>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <br><small class="text-secondary">{{ $student->nim }}</small>
                                </div>
                            </div>
                        </td>
                    ...
                    @empty
                    <tr><td colspan="4" class="text-center text-secondary py-5">Belum ada data leaderboard.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
